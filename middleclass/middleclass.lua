...
local _rawtostring = function(val) 
	print("RAW",self)
	return "raw"
	--return tostring(...)
end
...
local _metamethods = { -- all metamethods except __index
  '__add', '__call', '__concat', '__div', '__le', '__lt', '__mod', '__mul', '__pow', '__sub', '__unm', '__tostring' 
}
...
Object.__classDict = {
  initialize = _nilf, destroy = _nilf, subclassed = _nilf,
  	__tostring = function(instance) -- root of __tostring method
		local r, s
		if (instance.class) then
			--s = _rawtostring(instance)
			r =  ("instance of ".. instance.class.name )
		else
			r = "Object.__classDict.__index"
		end
...
setmetatable(Object, { 
  ...
  __call = Object.new,             -- allows instantiation via Object() //any Other class BUT for Object need Object.new(Object)
  __tostring = function() return "class Object" end -- allows tostring(Object)
})
